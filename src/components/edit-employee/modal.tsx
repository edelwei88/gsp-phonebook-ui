...
export function EditEmployeeModal({
  ...
  return (
    <>
      <div
        className='fixed bg-onyx opacity-75 inset-0 z-50 pointer-events-auto'
        onClick={onClose}
      ></div>
      ...
      <div className='fixed inset-0 flex items-center justify-center z-60 pointer-events-none'>
        <div className='flex place-content-center w-3/5'>
          <div
            className='w-2/3 rounded-xl bg-white dark:bg-charcoal shadow-lg transition-all duration-300
              hover:shadow-xl relative pointer-events-auto'
          >
            ...
            <div className='flex p-6 justify-start bg-alice dark:bg-onyxlight rounded-t-xl'>
              <div
                className='relative h-20 w-20 ml-10 overflow-hidden rounded-[15px] border-4 border-gray-400
                  dark:border-azul'
              >
                {employee.Photo ? (
                  <img
