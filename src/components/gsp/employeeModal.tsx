                ...
                <div className="w-2/3 rounded-xl bg-white shadow-lg transition-all duration-300 hover:shadow-xl mt-20 relative"> 
                    ...
                    <div className="px-5 py-4 m-10">
                        <div className="flex flex-col space-y-4">
                            ...
                            <div className="flex justify-between">
                                <h3 className="text-lg font-bold text-gray-800">Подразделение</h3>
                            ...
                            <div className="flex justify-between">
                                <h3 className="text-lg font-bold text-gray-800">Городской номер</h3>
                                <p className="text-gray-600"></p>
                            </div>

                            <div className="flex justify-between">
                                <h3 className="text-lg font-bold text-gray-800">Мобильный (рабочий)</h3>
                                <p className="text-gray-600">{employee.Phone}</p>
                            </div>

                            <div className="flex justify-between">
                                <h3 className="text-lg font-bold text-gray-800">Мобильный (личный)</h3>
